...
set xrange [1:64]
set yrange [1:65]
set output 'absolute_firstmv-board10-adapted_260620.png'
plot 'absolute-board10-fmv_260620.csv' title "board 10 absolute" with linesp, \
     'relative-board10-fmv_260620.csv' title "board 10 relative" with linesp, \
