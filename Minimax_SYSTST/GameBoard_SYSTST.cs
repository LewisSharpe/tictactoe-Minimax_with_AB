...
namespace Minimax_SYSTST
{
    ...
    struct GameBoard_SYSTST<T> where T: IComparable
    {
        // cell ids
        ...
        {
            string path = @"C://Users//LATITUDE//Desktop//ttt_csharp_081019_brokenupdate//Minimax_SYSTST//boards//intboards.txt";
        ...
        {
            string path = @"C://Users//LATITUDE//Desktop//ttt_csharp_081019_brokenupdate//Minimax_SYSTST//boards//finboards.txt";
            // This text is added only once to the file.
            // Create a file to write to.
        ...
        {
            string path = @"C://Users//LATITUDE//Desktop//ttt_csharp_081019_brokenupdate//Minimax_SYSTST//boards//scoreboards.txt";
            // This text is added only once to the file.
            // Create a file to write to.
        ...
        // PLACE ON EDGES
        public int PlaceAtBottomEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 2; x <= 6; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtTopEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 2; x <= 6; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtLeftEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 1; x <= 1; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtRightEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 7; x <= 7; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtInnerBottomEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 2; x <= 6; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtInnerTopEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 2; x <= 6; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtInnerLeftEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 1; x <= 1; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtInnerRightEdges(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 7; x <= 7; x++)
        ...
        // PLACE ON EDGES
        public int PlaceAtCentreBlock(GameBoard_SYSTST<T> copy, T counter)
        {
            int x = 0;
            int y = 0;
            for (x = 3; x <= 6; x++)
        ...
        public bool IsTwoLeftNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
        ...
        public Tuple<int, int> PrintTwoLeftNeighbour(GameBoard_SYSTST<T> board, T us)
        {
        ...
        public bool IsTwoRightNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public Tuple<int, int> PrintTwoRightNeighbour(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public bool IsTwoTopNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public Tuple<int, int> PrintTwoTopNeighbour(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public bool IsTwoBottomNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public Tuple<int, int> PrintTwoBottomNeighbour(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // IS LEFT CELL BESIDE TWO IN ROW EMPTY
        public bool IsOneLeftNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // PRINT LEFT EMPTY CELL BESIDE TWO IN ROW EMPTY
        public Tuple<int, int> PrintOneLeftNeighbour(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // IS RIGHT CELL BESIDE TWO IN ROW EMPTY
        public bool IsOneRightNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // PRINT RIGHT EMPTY CELL BESIDE TWO IN ROW EMPTY
        public Tuple<int, int> PrintOneRightNeighbour(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // IS TOP CELL BESIDE TWO IN ROW EMPTY
        public bool IsOneTopNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // PRINT TOP EMPTY CELL BESIDE TWO IN ROW EMPTY
        public Tuple<int, int> PrintOneTopNeighbour(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // IS BOTTOM CELL BESIDE TWO IN ROW EMPTY
        public bool IsOneBottomNeighbourEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        // PRINT BOTTOM EMPTY CELL BESIDE TWO IN ROW EMPTY
        public Tuple<int, int> PrintOneBottomNeighbour(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public bool IsTwoWithHorziGapEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public Tuple<int, int> PrintTwoWithHorziGap(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public bool IsTwoWithVerticalGapEmpty(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public Tuple<int, int> PrintTwoWithVerticalGap(GameBoard_SYSTST<T> board, T us)
        {
            // Debug.Assert(us == T.NOUGHTS || us == T.CROSSES);
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
        ...
        public GameBoard_SYSTST<T> Clone()
        {
            GameBoard_SYSTST<T> g = new GameBoard_SYSTST<T>();
            for (int x = 1; x <= 7; x++)
                for (int y = 1; y <= 7; y++)
                    g[x, y] = this[x,y];
            return g;
