...
namespace Minimax_TPL
{
    ...
    struct GameBoard_TPL <T> where T: IComparable
    {
        ...
        {
            string path = @"C://Users//LATITUDE//Desktop//ttt_csharp_041019_stable//Minimax_TPL//boards//intboards.txt";
            // This text is added only once to the file.
            // Create a file to write to.
             File.WriteAllText(@"C://Users//LATITUDE//Desktop//ttt_csharp_041019_stable//Minimax_TPL//boards//intboards.txt", string.Empty);
        ...
        {
            string path = @"C://Users//LATITUDE//Desktop//ttt_csharp_041019_stable//Minimax_TPL//boards//finboards.txt";
            // This text is added only once to the file.
            // Create a file to write to.
             File.WriteAllText(@"C://Users//LATITUDE//Desktop//ttt_csharp_041019_stable//Minimax_TPL//boards//finboards.txt", string.Empty);
            using (StreamWriter sw = new StreamWriter(path, true))
            {
        ...
        {
            string path = @"C://Users//LATITUDE//Desktop//ttt_csharp_041019_stable//Minimax_TPL//boards//scoreboards.txt";
            // This text is added only once to the file.
            // Create a file to write to.
            File.WriteAllText(@"C://Users//LATITUDE//Desktop//ttt_csharp_041019_stable//Minimax_TPL//boards//scoreboards.txt", string.Empty);
            using (StreamWriter sw = new StreamWriter(path, true))
            {
