...
set title 'Absolute Speed-up for first move on Board 5'
set xlabel 'cores'
set ylabel 'speed up'
set term png
# type set to 'png''
...
set xrange [1:64]
set yrange [1:275]
set output 'absolute_firstmv-board5-adapted_140620.png'
plot 'absolute-board5_140620.csv' title "board 10 absolute" with linesp, \
     'relative-board5_140620.csv' title "board 10 relative" with linesp, \
