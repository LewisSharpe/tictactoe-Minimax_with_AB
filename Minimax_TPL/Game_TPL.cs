...
*/
	    ...
	    // Create new stopwatch.
		    ...
		    expectedMove = new Tuple<int, int>(1,1);
                    board[1, 1] = counters.X; board[2, 1] = counters.X; board[3, 1] = counters.e; board[4, 1] = counters.N; board[5, 1] = counters.e; board[6, 1] = counters.e; board[7, 1] = counters.e;
                    board[1, 2] = counters.N; board[2, 2] = counters.N; board[3, 2] = counters.N; board[4, 2] = counters.N; board[5, 2] = counters.e; board[6, 2] = counters.e; board[7, 2] = counters.e;
