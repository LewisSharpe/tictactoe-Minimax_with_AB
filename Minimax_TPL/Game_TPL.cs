	    ...
	    // Create new stopwatch.
		    ...
		    expectedMove = new Tuple<int, int>(2,3);
                ...
                case 2:
                    currentPlayer.counter = counters.X; // HWL: set the current player here as well
                    expectedMove = new Tuple<int, int>(2, 3);
                    board[1, 1] = counters.N; board[2, 1] = counters.e; board[3, 1] = counters.X; board[4, 1] = counters.X; board[5, 1] = counters.e; board[6, 1] = counters.e; board[7, 1] = counters.e;
                    board[1, 2] = counters.N; board[2, 2] = counters.e; board[3, 2] = counters.e; board[4, 2] = counters.X; board[5, 2] = counters.e; board[6, 2] = counters.e; board[7, 2] = counters.e;
                ...
                case 4:
                    startingCounter = counters.X; // state starting counter of gameplay
                    board[1, 1] = counters.N; board[2, 1] = counters.N; board[3, 1] = counters.N; board[4, 1] = counters.e; board[5, 1] = counters.N; board[6, 1] = counters.N; board[7, 1] = counters.N;
                    board[1, 2] = counters.N; board[2, 2] = counters.N; board[3, 2] = counters.N; board[4, 2] = counters.e; board[5, 2] = counters.N; board[6, 2] = counters.N; board[7, 2] = counters.N;
                    board[1, 3] = counters.N; board[2, 3] = counters.N; board[3, 3] = counters.N; board[4, 3] = counters.O; board[5, 3] = counters.N; board[6, 3] = counters.N; board[7, 3] = counters.N;
                    board[1, 4] = counters.e; board[2, 4] = counters.e; board[3, 4] = counters.e; board[4, 4] = counters.N; board[5, 4] = counters.e; board[6, 4] = counters.e; board[7, 4] = counters.e;
                    board[1, 5] = counters.N; board[2, 5] = counters.N; board[3, 5] = counters.N; board[4, 5] = counters.e; board[5, 5] = counters.N; board[6, 5] = counters.N; board[7, 5] = counters.N;
                    board[1, 6] = counters.N; board[2, 6] = counters.N; board[3, 6] = counters.N; board[4, 6] = counters.e; board[5, 6] = counters.N; board[6, 6] = counters.N; board[7, 6] = counters.N;
                    board[1, 7] = counters.N; board[2, 7] = counters.N; board[3, 7] = counters.N; board[4, 7] = counters.e; board[5, 7] = counters.N; board[6, 7] = counters.N; board[7, 7] = counters.N;
                    break;
                case 5:
                    ...
                    board[1, 1] = counters.X; board[2, 1] = counters.e; board[3, 1] = counters.N; board[4, 1] = counters.e; board[5, 1] = counters.e; board[6, 1] = counters.e; board[7, 1] = counters.e;
	      ...
	      case 7: // X should pick (3,3) (with maxPly=4), which then results in Board 1, which is an X win
                    ...
                    board[1, 1] = counters.N; board[2, 1] = counters.N; board[3, 1] = counters.N; board[4, 1] = counters.N; board[5, 1] = counters.N; board[6, 1] = counters.e; board[7, 1] = counters.N;
                    board[1, 2] = counters.O; board[2, 2] = counters.N; board[3, 2] = counters.N; board[4, 2] = counters.N; board[5, 2] = counters.N; board[6, 2] = counters.e; board[7, 2] = counters.N;
                    board[1, 3] = counters.N; board[2, 3] = counters.e; board[3, 3] = counters.N; board[4, 3] = counters.N; board[5, 3] = counters.N; board[6, 3] = counters.e; board[7, 3] = counters.N;
                    board[1, 4] = counters.N; board[2, 4] = counters.N; board[3, 4] = counters.O; board[4, 4] = counters.N; board[5, 4] = counters.e; board[6, 4] = counters.e; board[7, 4] = counters.e;
                    board[1, 5] = counters.N; board[2, 5] = counters.N; board[3, 5] = counters.N; board[4, 5] = counters.N; board[5, 5] = counters.N; board[6, 5] = counters.N; board[7, 5] = counters.N;
                    board[1, 6] = counters.N; board[2, 6] = counters.N; board[3, 6] = counters.N; board[4, 6] = counters.N; board[5, 6] = counters.N; board[6, 6] = counters.N; board[7, 6] = counters.N;
                ...
                case 8:
                    ...
                    board[1, 1] = counters.N; board[2, 1] = counters.N; board[3, 1] = counters.N; board[4, 1] = counters.N; board[5, 1] = counters.N; board[6, 1] = counters.e; board[7, 1] = counters.N;
                    board[1, 2] = counters.X; board[2, 2] = counters.N; board[3, 2] = counters.N; board[4, 2] = counters.N; board[5, 2] = counters.N; board[6, 2] = counters.e; board[7, 2] = counters.N;
                    board[1, 3] = counters.N; board[2, 3] = counters.e; board[3, 3] = counters.N; board[4, 3] = counters.N; board[5, 3] = counters.N; board[6, 3] = counters.O; board[7, 3] = counters.N;
                    board[1, 4] = counters.N; board[2, 4] = counters.N; board[3, 4] = counters.X; board[4, 4] = counters.N; board[5, 4] = counters.e; board[6, 4] = counters.e; board[7, 4] = counters.e;
                    board[1, 5] = counters.N; board[2, 5] = counters.N; board[3, 5] = counters.N; board[4, 5] = counters.N; board[5, 5] = counters.N; board[6, 5] = counters.N; board[7, 5] = counters.N;
                    board[1, 6] = counters.N; board[2, 6] = counters.N; board[3, 6] = counters.N; board[4, 6] = counters.N; board[5, 6] = counters.N; board[6, 6] = counters.N; board[7, 6] = counters.N;
                    board[1, 7] = counters.N; board[2, 7] = counters.N; board[3, 7] = counters.N; board[4, 7] = counters.N; board[5, 7] = counters.N; board[6, 7] = counters.N; board[7, 7] = counters.N;
                    break;
                case 9:
                    startingCounter = counters.O; // state starting counter of gameplay
                    board[1, 1] = counters.e; board[2, 1] = counters.e; board[3, 1] = counters.N; board[4, 1] = counters.N; board[5, 1] = counters.N; board[6, 1] = counters.e; board[7, 1] = counters.e;
                    board[1, 2] = counters.e; board[2, 2] = counters.e; board[3, 2] = counters.N; board[4, 2] = counters.N; board[5, 2] = counters.N; board[6, 2] = counters.e; board[7, 2] = counters.e;
                    board[1, 3] = counters.e; board[2, 3] = counters.e; board[3, 3] = counters.N; board[4, 3] = counters.N; board[5, 3] = counters.N; board[6, 3] = counters.e; board[7, 3] = counters.e;
                    board[1, 4] = counters.e; board[2, 4] = counters.e; board[3, 4] = counters.N; board[4, 4] = counters.N; board[5, 4] = counters.N; board[6, 4] = counters.e; board[7, 4] = counters.e;
                    board[1, 5] = counters.e; board[2, 5] = counters.e; board[3, 5] = counters.N; board[4, 5] = counters.N; board[5, 5] = counters.N; board[6, 5] = counters.e; board[7, 5] = counters.e;
                    board[1, 6] = counters.e; board[2, 6] = counters.e; board[3, 6] = counters.N; board[4, 6] = counters.N; board[5, 6] = counters.N; board[6, 6] = counters.e; board[7, 6] = counters.e;
                    board[1, 7] = counters.e; board[2, 7] = counters.e; board[3, 7] = counters.N; board[4, 7] = counters.N; board[5, 7] = counters.N; board[6, 7] = counters.e; board[7, 7] = counters.e;
                    break;
                case 10:
                    startingCounter = counters.X; // state starting counter of gameplay
                 ...
                 //     Debug.Assert(board[bestMove.Item1, bestMove.Item2] == counters.X || board[bestMove.Item1, bestMove.Item2] == counters.O);
                        ...
                        if (IsOver(board, currentPlayer))
                        {
                            lock (ID_LOCK)
                            {
                                ...
                                Console.WriteLine(Program.no_of_cores_for_parallelism + "**CORES-- LS Memory consumption: " + proc.PrivateMemorySize64 + "bytes");
                                Console.WriteLine(Program.no_of_cores_for_parallelism + "**CORES-- LS Garbage collections: {0}", GC.GetTotalMemory(false) + "bytes.");
                                Console.WriteLine("--------------------------------------------------------------------------------------------------------");
